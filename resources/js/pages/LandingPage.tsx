import { BookOpen, Library, Users, Search, Sparkles, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50">
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">DigiLib</h1>
              <p className="text-xs text-green-600">Perpustakaan Digital Sekolah</p>
            </div>
          </div>
          <div className="flex gap-3">
            <Button variant="outline" onClick={() => onNavigate('user')}>
              Masuk Sebagai User
            </Button>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Akses ribuan buku digital, baca langsung di browser, dan tingkatkan literasi dengan teknologi modern. Semua dalam satu platform yang mudah digunakan.
            </p>
            <div className="flex gap-4">
              <Button size="lg" onClick={() => onNavigate('user')}>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Pengalaman membaca digital yang sempurna</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          <Card hover className="p-8">
            ...
            <h4 className="text-2xl font-bold text-gray-900 mb-3">Pencarian Cerdas</h4>
            <p className="text-gray-600 leading-relaxed">
              Temukan buku yang Anda cari dengan mudah menggunakan sistem pencarian canggih berdasarkan judul, penulis, atau kategori.
            </p>
          </Card>
          ...
          <Card hover className="p-8">
            ...
            <h4 className="text-2xl font-bold text-gray-900 mb-3">Baca Online</h4>
            <p className="text-gray-600 leading-relaxed">
              Nikmati pengalaman membaca yang nyaman langsung di browser tanpa perlu download. Tersedia mode gelap untuk kenyamanan mata.
            </p>
          </Card>
          ...
          <Card hover className="p-8">
            ...
            <h4 className="text-2xl font-bold text-gray-900 mb-3">Komunitas Aktif</h4>
            <p className="text-gray-600 leading-relaxed">
              Bergabung dengan ribuan siswa lainnya. Lihat rekomendasi buku populer dan bagikan ulasan dengan teman-teman.
            </p>
          </Card>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-semibold">Untuk Guru & Admin</span>
              </div>
              <h3 className="text-4xl font-bold mb-6">
                Kelola Perpustakaan dengan Mudah
              </h3>
              <p className="text-xl text-green-50 mb-8 leading-relaxed">
                Dashboard admin yang powerful untuk mengelola koleksi buku, memantau aktivitas peminjaman, dan menganalisis statistik penggunaan perpustakaan.
              </p>
              <Button variant="secondary" size="lg" onClick={() => onNavigate('admin')}>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="p-6 bg-white/10 backdrop-blur-lg text-white border border-white/20">
                ...
                <p className="text-green-100">Rating Pengguna</p>
              </Card>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">DigiLib</span>
              </div>
              <p className="text-gray-400">
                Platform perpustakaan digital modern untuk meningkatkan literasi di lingkungan sekolah.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-green-500 transition-colors">Koleksi Buku</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>Email: info@digilib.sch.id</li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 DigiLib - Perpustakaan Digital Sekolah. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
