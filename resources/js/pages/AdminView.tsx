    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* ⬅ GANTI BUTTON KEMBALI KE ROUTER */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <Card className="p-6 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Kelola Koleksi Buku</h2>
              ...
              <tbody>
                {filteredBooks.map(book => (
                  <tr key={book.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4 font-semibold">{book.title}</td>
                    ...
                    <td className="py-4 px-4 text-center">{book.pages}</td>
                    <td className="py-4 px-4 text-center text-orange-600 font-semibold">{book.borrowed}</td>
                    <td className="py-4 px-4 text-center text-green-600 font-semibold">{book.available}</td>
                    <td className="py-4 px-4">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6">
          <Card className="max-w-2xl w-full p-8">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold">Tambah Buku Baru</h3>
